/**
 * @agentjam/adapters — Windsurf Adapter
 *
 * Exports agents to .windsurfrules format.
 */
...
export class WindsurfAdapter extends BaseAdapter {
  ...
  exportSkill(bundle: ResourceBundle<SkillManifest>): ExportResult {
    ...
    return {
      harness: this.harnessName,
      files: {
        [`.codeium/windsurf/skills/${manifest.name}.md`]: `# ${manifest.name}\n\n${body}`,
      },
    };
  }
}
